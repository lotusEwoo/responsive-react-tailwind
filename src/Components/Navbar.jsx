  ...
  return (
    <div className="text-white flex justify-between h-24 mx-auto px-4 max-h-[1240px] items-center">
      ...
      <ul className="hidden md:flex ">
        <li className="p-4" onClick={() => setPage("items")}>
          Item List
        </li>
      ...
      <div
        className={
          nav
            ? "left-0 top-0 fixed h-full w-[60%] bg-[#000300] border-r border-r-gray-900 ease-in-out duration-500 z-50"
            : "fixed left-[-100%]"
        }
      >
        ...
        <ul className="uppercase p-4">
          <li
            className="p-4 border-b border-b-lime-700"
            onClick={() => {
              setPage("items");
              handleNav();
            }}
